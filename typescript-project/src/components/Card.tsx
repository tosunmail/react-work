  ...
  return (
    <div className="w-10/12 sm:w-6/12 md:w-4/12 lg:w-3/12 flex flex-col justify-between bg-white rounded-lg">
      ...
      <div className="flex justify-between items-center bg-gray-700 p-3">
        ...
        <button className="bg-gray-300 p-1 rounded-lg animate-pulse hover:animate-none outline-none focus:ring-4 shadow-lg transform active:scale-x-75 transition-transform " onClick={()=>handleFunc(item)}>{text}</button>
      </div>
    </div>
  );
};
